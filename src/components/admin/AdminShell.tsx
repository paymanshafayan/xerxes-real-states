...
export default function AdminShell() {
  ...
  const handleDataSourceChange = async (source: string) => {
    ...
    try {
      ...
      await Promise.all([fetchStats(), fetchProperties(), fetchAgents()]);
    } catch (err) {
  ...
  const handleSaveAgent = async (data: Partial<SampleAgent>) => {
    if (editingAgent) {
      await authFetch(`/api/agents/${editingAgent.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(data),
      });
  ...
  const openSectionHelp = (section: string) => {
                ...
                <button
                  ...
                  onClick={() =>
                    handleDataSourceChange(
                      stats.dataSource === "database" ? "sample" : "database"
                    )
                  }
                  disabled={loading}
                  ...
                  title="Click to toggle between Sample Data and Database mode"
                >
                  {loading ? (
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => openSectionHelp("properties")}
          ...
          {activeTab === "agents" && (
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => openSectionHelp("agents")}
                    className="p-2 text-gray-400 hover:text-primary rounded-lg hover:bg-gray-100"
                  >
                    <HelpCircle className="w-4 h-4" />
                  </button>
          ...
          {activeTab === "inquiries" && (
            <div>
              <div className="flex justify-end mb-4">
                <button
                  onClick={() => openSectionHelp("inquiries")}
                  className="p-2 text-gray-400 hover:text-primary rounded-lg hover:bg-gray-100"
                >
                  <HelpCircle className="w-4 h-4" />
                </button>
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex gap-1">
                                <button
                                  onClick={() =>
                                    handleInquiryStatus(inq.id, "read")
                                  }
                                  className="p-1 text-gray-500 hover:bg-gray-100 rounded"
                                  title="Read"
                                >
                                ...
                                <button
                                  onClick={() =>
                                    handleInquiryStatus(inq.id, "resolved")
                                  }
                                  className="p-1 text-gray-500 hover:bg-gray-100 rounded"
                                  title="Resolve"
                                >
            ...
            <div className="max-w-2xl space-y-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-xs">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Select where the website and mobile applications load property and agent data from.
                </p>
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Load verified properties and agents directly from sample data file
                      </p>
                    </div>
                  </label>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Load from PostgreSQL database (automatically falls back to sample data if database is empty)
                      </p>
                    </div>
                  </label>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-xs">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Import sample data into the PostgreSQL database tables.
                </p>
                <button
                  onClick={handleSeedData}
                  disabled={loading}
                  className="flex items-center gap-2 px-4 py-2.5 bg-primary text-white text-sm font-semibold rounded-lg hover:bg-primary-dark disabled:opacity-50 transition-colors"
                >
